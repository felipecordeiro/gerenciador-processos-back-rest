...
public class UsuarioResource {
	...
	private void carregaUsuarios() {
		...
		// password do finalizador é "senha3"
		usuarios.add(
				(new Usuario(1L, "administrador", "a991e84c62a25c5a972f67c47cd81f31063c2dde905a8428977b0458073465cd",
						"João", Funcao.USUARIO_ADMINISTRADOR)));
		usuarios.add((new Usuario(2L, "triador", "02a3e1fc659a693124e09cc25a8b49249e126cbfa0dddf8f45d4dee4895bf81e",
				"Gabriela", Funcao.USUARIO_TRIADOR)));
		usuarios.add((new Usuario(3L, "finalizador", "503ae5403efc54b676a4b551f30d9439e42aa4c362e8d21dc37a4250cfa19e17",
				"Maria", Funcao.USUARIO_FINALIZADOR)));
	}
